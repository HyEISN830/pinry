...
IMAGE_THUMBNAIL_THROTTLE_BYTES_PER_SECOND = _env_int(
...
CHUNKED_UPLOAD_CHUNK_SIZE = _env_int(
    'CHUNKED_UPLOAD_CHUNK_SIZE',
    256 * 1024,
)
CHUNKED_UPLOAD_MAX_IMAGE_SIZE = _env_int(
    'CHUNKED_UPLOAD_MAX_IMAGE_SIZE',
    256 * 1024 * 1024,
)
CHUNKED_UPLOAD_MAX_AVATAR_SIZE = _env_int(
    'CHUNKED_UPLOAD_MAX_AVATAR_SIZE',
    2 * 1024 * 1024,
)
CHUNKED_UPLOAD_SESSION_AGE = _env_int(
    'CHUNKED_UPLOAD_SESSION_AGE',
    24 * 60 * 60,
)
CHUNKED_UPLOAD_PROCESSING_TIMEOUT_SECONDS = _env_int(
