...
.comic-card { position:relative; isolation:isolate; overflow:hidden; min-width:0; color:inherit; cursor:pointer; border:1px solid var(--color-border-accent,var(--accent-border,rgba(126,87,194,.42))); border-radius:var(--radius-card,22px); background:radial-gradient(circle at top left,var(--theme-glow-start,var(--theme-glow)),transparent 240px),radial-gradient(circle at bottom right,var(--theme-glow-end,var(--theme-glow)),transparent 260px),var(--color-surface-card,var(--surface-card,#fff)); box-shadow:0 0 0 2px var(--accent-soft,rgba(126,87,194,.08)),var(--shadow-card,0 18px 50px rgba(15,23,42,.16)); transform-style:preserve-3d; will-change:transform; }
.comic-card::before,.comic-card::after { content:""; position:absolute; left:var(--space-sm,12px); right:var(--space-sm,12px); height:12px; border:1px solid var(--accent-border,rgba(126,87,194,.22)); border-radius:0 0 var(--radius-sm,8px) var(--radius-sm,8px); background:var(--accent-soft-gradient,var(--accent-soft,#faf7ff)); pointer-events:none; }
.comic-card::before { bottom:-7px; z-index:-1; }.comic-card::after { bottom:-13px; left:var(--space-lg,24px); right:var(--space-lg,24px); background:var(--accent-soft-gradient,var(--surface-accent,#f0ebff)); z-index:-2; }
...
.comic-ribbon { position:absolute; z-index:4; top:var(--space-sm,12px); left:var(--space-sm,12px); padding:.25rem .45rem; border-radius:var(--radius-sm,8px); color:var(--accent-text,#fff); background:var(--accent-fill,var(--accent-strong,#7e57c2)); font-size:12px; font-weight:900; letter-spacing:.02em; text-shadow:var(--accent-text-shadow,none); }
...
.comic-tags { display:flex; flex-wrap:wrap; gap:.32rem; max-height:3.25rem; margin-top:8px; overflow:hidden; }.comic-tags a,.comic-tag-more { max-width:100%; padding:.15rem .42rem; border:0; border-radius:999px; color:var(--accent-strong,#6d4bc1); background:var(--accent-soft-gradient,var(--accent-soft,#f2edff)); font-size:12px; font-weight:800; line-height:1.35; text-overflow:ellipsis; white-space:nowrap; overflow:hidden; }.comic-tag-more { color:var(--color-text-muted,var(--text-muted,#64748b)); background:var(--color-surface-muted,var(--surface-2,#eef1f5)); cursor:pointer; }
